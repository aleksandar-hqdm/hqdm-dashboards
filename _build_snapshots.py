        ...
        'focus': [
            {'title': 'Build Calendar · June → August 2026', 'color': '#1d5b8a',
             'body': (
                 ...
                 '<tr><td class="row-label">Google profile<span class="cap">profile hygiene that feeds the map pin</span></td>'
                 '<td><div class="item"><span class="tag fix">GBP</span><span style="color:#0b1220;font-weight:600">Services + attributes</span></div>'
                 '<div class="n">Audit the Services tab and write proper descriptions. Tighten the profile attributes and description to surface what sets you apart: women-owned, LGBTQ-affirming, transgender-safe, OASAS-licensed, same-day admissions.</div></td>'
                 '<td><div class="n">Keep the Services list and attributes in sync as the new service pages ship.</div></td>'
                 '<td><div class="item"><span class="tag fix">GBP</span><span style="color:#0b1220;font-weight:600">Final audit</span></div>'
                 '<div class="n">Final pass over the Services tab, categories, and attributes.</div></td></tr>'
