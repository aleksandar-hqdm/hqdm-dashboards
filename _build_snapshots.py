...
CLIENTS = {
    ...
    'niagara-recovery': {
        ...
        'exec_html': ("<p>Niagara Recovery <strong>owns its home market</strong> — 100% of Maps cells within 15 miles of the Newfane pin "
                      ...
                      "pulled back sharply. The plan: a brand-canonical fix sitewide, a Google Business service-area swap, "
                      "service-page consolidation, and a doorway cleanup.</p>"),
        ...
        'focus': [
            ...
            {'title': 'GBP service-area swap', 'color': '#10b981', 'body': 'Swap the Google Business service area off the capped ZIP set.'},
    ...
    'arms-acres': {
        ...
        'calendar': {
            ...
            'note_html': 'Scope is the managed Carmel pin and the website pages it feeds. Citations run through the quarter.',
        },
    },
    ...
    'conifer-park': {
        ...
        'focus': [
            ...
            {'title': 'Google Business depth', 'color': '#1d5b8a', 'body': 'A full pass on the Glenville profile: description, services list pointed at the right pages, attributes, plus a tracking tag so the Maps clicks show up by location.'},
 ...
 'note_html': 'Scope is the managed Glenville pin and the website pages it feeds. Citations run through the '
              'quarter.'},
    },
