...
CLIENTS = {
    ...
    'urban-recovery': {
        ...
        'focus': [
            {'title': 'GBP depth surge', 'color': '#10b981', 'body': 'Defend and deepen the Red Hook Google Business profile: posts, photos, services, and Q&A.'},
            ...
            {'title': 'Tighten the Brooklyn pages', 'color': '#6366f1', 'body': 'Strengthen the location pages inside Red Hook’s local reach and redirect the thin out-of-area ones. No new pins.'},
