...
timeline = [
    ...
    },
    {
        ...
        "body": "Authority strategy pivoted from automated stack (SEO Neo / off-page vendor) to manual + earned channels (AMTA / ABMP / Utah MTA citations, monthly digital-PR pitch, monthly partner-outreach touch). Deliberate course correction - short-term it slows backlink velocity; medium-term it removes algorithmic risk and builds defensible local authority."
    },
]
